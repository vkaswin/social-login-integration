...
class HomePage extends Component{
    ...
    onLogout(){
        ...
        this.setState({
            sessionLogin : userInfo.sessionLogin
        })
        ...
        return (
            <div className="container-fluid">
                <h2 className="header-home">
                    <img onClick={()=>this.handleClick()} className="bar-img" src={require('../images/bar.png')}></img>  Welcome to {this.state.title}
                    <button className="btn btn-primary btn-log" onClick={()=>this.onLogout()}>Logout</button>
                </h2>
                ...
                <div className="row">
                    ...
                    <Switch>
                        ...
                        <ProtectedRoute path='/homepage/database' component={Database}></ProtectedRoute>
                    </Switch>
                    </div>
                </div>
